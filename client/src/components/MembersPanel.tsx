...
const styles: Record<string, React.CSSProperties> = {
  panel: { width: '240px', background: '#0e0d24', borderLeft: '1px solid #2e2b56',
    display: 'flex', flexDirection: 'column', height: '100vh', overflowY: 'auto' },
  header: { padding: '16px', borderBottom: '1px solid #2e2b56',
    display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  title: { color: '#ede9fe', fontWeight: 600, fontSize: '14px', flex: 1 },
  nameInput: { background: '#13122c', border: '1px solid #7c3aed', borderRadius: '4px',
    color: '#ede9fe', padding: '2px 6px', fontSize: '14px', width: '140px' },
  editHint: { color: '#8b89b0', fontSize: '12px' },
  closeBtn: { background: 'none', border: 'none', color: '#8b89b0',
    cursor: 'pointer', fontSize: '20px', lineHeight: 1 },
  section: { padding: '12px 16px', borderBottom: '1px solid #1a1834' },
  sectionLabel: { color: '#6b5fa0', fontSize: '11px', fontWeight: 700,
    textTransform: 'uppercase', marginBottom: '8px', letterSpacing: '0.5px' },
  searchInput: { width: '100%', padding: '8px', background: '#13122c',
    border: '1px solid #2e2b56', borderRadius: '6px', color: '#ede9fe',
    fontSize: '13px', marginBottom: '6px' },
  searchResult: { display: 'flex', justifyContent: 'space-between',
    alignItems: 'center', padding: '6px 0' },
  inviteBtn: { background: 'linear-gradient(135deg, #7c3aed, #9966ff)', border: 'none',
    color: '#fff', borderRadius: '4px', padding: '4px 8px', cursor: 'pointer', fontSize: '12px' },
  ...
  onlineDot: { width: '10px', height: '10px', borderRadius: '50%',
    border: '2px solid #0e0d24', position: 'absolute', bottom: 0, right: 0 },
  memberInfo: { flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' },
  memberName: { color: '#ede9fe', fontSize: '13px', fontWeight: 500 },
  memberRole: { color: '#8b89b0', fontSize: '11px' },
  you: { color: '#8b89b0', fontWeight: 400 },
  removeBtn: { background: 'none', border: 'none', color: '#f87171',
  ...
  leaveBtn: { width: '100%', padding: '10px', background: 'transparent',
    border: '1px solid #f87171', color: '#f87171', borderRadius: '6px',
