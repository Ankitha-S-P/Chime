...
const styles: Record<string, React.CSSProperties> = {
  overlay: { position: 'fixed', inset: 0, background: 'rgba(4,3,16,0.8)',
    display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 },
  modal: { background: '#0e0d24', borderRadius: '14px', width: '400px',
    maxHeight: '500px', display: 'flex', flexDirection: 'column',
    border: '1px solid #2e2b56', overflow: 'hidden',
    boxShadow: '0 0 40px rgba(124,58,237,0.2)' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    padding: '16px 20px', borderBottom: '1px solid #2e2b56' },
  title: { color: '#ede9fe', margin: 0, fontSize: '16px', fontWeight: 600 },
  ...
  input: { margin: '12px 16px', padding: '10px 14px', borderRadius: '8px',
    border: '1px solid #2e2b56', background: '#13122c', color: '#ede9fe', fontSize: '14px' },
  results: { flex: 1, overflowY: 'auto', padding: '0 16px 16px' },
  empty: { color: '#3d3660', textAlign: 'center', marginTop: '20px' },
  userRow: { display: 'flex', alignItems: 'center', gap: '12px',
    padding: '10px 0', borderBottom: '1px solid #1a1834' },
  ...
  username: { color: '#ede9fe', fontSize: '14px', fontWeight: 500 },
  email: { color: '#8b89b0', fontSize: '12px' },
  startBtn: { background: 'linear-gradient(135deg, #7c3aed, #9966ff)', border: 'none',
    color: '#fff', borderRadius: '6px', padding: '6px 12px', cursor: 'pointer', fontSize: '13px' },
};
